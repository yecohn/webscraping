...
for year in YEARS:
    for row in welfare_data.log_ranking(SUBJECT_NAME, year)[1:]:
        if row[0] in dic_country:
            ...
            fields = [dic_country[row[0]], year, *row]
        else:
            ...
            mydb.commit()
        cur.execute("INSERT INTO property_price (country_id, year, country, price_to_income, gross_rental_inside_center, gross_rental_outside_center, \
...
for year in YEARS:
    for row in welfare_data.log_ranking(SUBJECT_NAME, year)[1:]:
        if row[0] in dic_country:
            ...
            cur.execute('INSERT INTO countries(country_name) VALUES (%s)', (row[0],))
            mydb.commit()
        cur.execute("INSERT INTO cost_of_living (country_id, year, country, cost_of_living, rent, cost_of_living_and_rent, \
...
for year in YEARS:
    for row in welfare_data.log_ranking(SUBJECT_NAME, year)[1:]:
        if row[0] in dic_country:
            ...
            cur.execute('INSERT INTO countries(country_name) VALUES (%s)', (row[0],))
            mydb.commit()
        cur.execute("INSERT INTO traffic (country_id, year, country, traffic_id, time_id, time_exp_id, inefficiency_id , \
...
for year in YEARS:
    for row in welfare_data.log_ranking(SUBJECT_NAME, year)[1:]:
        if row[0] in dic_country:
            ...
            cur.execute('INSERT INTO countries(country_name) VALUES (%s)', (row[0],))
            mydb.commit()
        cur.execute("INSERT INTO health_care (country_id, year, country, health_care_id, health_care_exp_id) VALUES \
                                    (%s,%s, %s, %s, %s)", fields)
...
for year in YEARS:
    for row in welfare_data.log_ranking(SUBJECT_NAME, year)[1:]:
        if row[0] in dic_country:
            ...
            cur.execute('INSERT INTO countries(country_name) VALUES (%s)', (row[0],))
            mydb.commit()
        cur.execute("INSERT INTO pollution (country_id, year, country, pollution_id, exp_pollution_id) VALUES \
                                    (%s ,%s, %s, %s, %s)", fields)
...
for year in YEARS:
    for row in welfare_data.log_ranking(SUBJECT_NAME, year)[1:]:
        ...
        cur.execute("INSERT INTO quality_life (country_id, year, country, quality_life_id, purchase_power_id, safety_id, \
...
for year in YEARS:
    for row in welfare_data.log_ranking(SUBJECT_NAME, year)[1:]:
        if row[0] in dic_country:
            ...
            cur.execute('INSERT INTO countries(country_name) VALUES (%s)', (row[0],))
            mydb.commit()
        cur.execute("INSERT INTO crime (country_id, year, country, crime_id, safety_id) VALUES \
                                    (%s, %s, %s, %s, %s )", fields)
